...
- **Spark emitter** (`emitCollisionSparks`): triggered by `CollisionResult.collided`. Spawns 5-25 orange/yellow square particles at contact point, count scales with `impactSpeed`. Scatter along wall normal.
