...
| Sound | active | `src/sound/sound.ts`, `src/sound/synth.ts`, `src/sound/definitions/` — procedural Web Audio synthesis, 10 sounds, lazy init |
...
| `src/sound/` | Procedural sound system (SoundSystem factory + Web Audio API) |
| `src/sound/definitions/` | Individual sound type definitions (engine, collision, pickup, flood, ambient, penalty) |
| `public/` | Static HTML |
| `dist/` | Build output |
